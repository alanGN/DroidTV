package com.example.alan_pc.droidtv.presentation.home.adapter
...
class TvShowAdapter(val tvShowList: MutableList<TvShow>, val listener: (TvShow) -> Unit) : RecyclerView.Adapter<TvShowAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_tv_show_card, parent, false)
        return ViewHolder(v)
    }
